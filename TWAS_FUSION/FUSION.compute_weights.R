...
# --- HERITABILITY ANALYSIS (patched to skip GCTA and set default hsq)
if ( TRUE ) {
  if ( opt$verbose >= 1 ) cat("### Skipping heritability estimation and setting hsq = 0.5\n")
  hsq = c(0.5, 0.01)   # You can set to another value if you wish (first = heritability, second = SE)
  hsq.pv = 0.0         # p-value (dummy)
}
